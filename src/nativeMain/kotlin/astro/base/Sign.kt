...
enum class Sign {
    ...
    , SAGITTARIUS { override fun getElement() = SignElement.FIRE_ELEMENT; override fun getMode() = SignMode.MUTABLE_MODE }
    , CAPRICORN { override fun getElement() = SignElement.EARTH_ELEMENT; override fun getMode() = SignMode.CARDINAL_MODE }
