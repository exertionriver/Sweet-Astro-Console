...
data class EarthLocation(val longitude : Double = Constants.LON_TNM
    , val latitude : Double = Constants.LAT_TNM
    , val altitude : Double = Constants.ALT_TNM.toDouble()
    ...
    companion object {
        ...
        fun getDefaultEarthLocation(utcDate : LocalDate) = EarthLocation(Constants.LON_TNM, Constants.LAT_TNM, Constants.ALT_TNM, Constants.TZ_MST, utcDate)
